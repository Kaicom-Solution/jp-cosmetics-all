...
import ReviewSubmitComponent from "./ReviewSumitComponent";
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-2">
        <div className="relative w-full max-w-lg rounded-3xl bg-white shadow-2xl shadow-black/20">
          ...
          <div className=" space-y-6">
            ...
            <div className="max-h-[75vh] overflow-y-auto space-y-6 p-3">
              {/* Items */}
                  ...
                  return (
                    <div key={index}>
                      <div className="flex items-start gap-3 min-w-0">
                        ...
                        {/* Text */}
                        <div className="min-w-0 w-[calc(100%-60px)] text-xs">
                          ...
                          <div className="flex justify-between items-start flex-wrap">
                            ...
                            {orderDetails?.order?.order_status ==
                              ...
                              <button
                                onClick={() =>
                                  setActiveReviewIndex(
                                    activeReviewIndex === index ? null : index,
                                  )
                                }
                                className="flex items-center gap-2 rounded-full px-3 py-1 text-xs font-semibold capitalize bg-gradient-to-r from-pink-500 to-rose-600 text-white cursor-pointer"
                              >
                      ...
                      <div className="mt-3 flex items-center justify-between rounded-xl bg-gray-50 px-4 py-2 text-gray-600 text-sm font-medium ">
                        ...
                        <span className="">৳{item.payable}</span>
                      </div>
                    </div>
                  );
                })}
              ...
              <div className=" rounded-2xl bg-gradient-to-r from-pink-500 to-rose-600 px-5 py-4 text-white space-y-1">
                <div className="flex items-center justify-between gap-1 text-sm font-medium">
                  ...
                  <span className="">
                    {orderDetails?.order?.sub_total_amount}
                  </span>
                </div>
                <div className="flex items-center justify-between gap-1 text-sm font-medium">
